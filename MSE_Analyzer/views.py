...
def services(request):
    ...
    api_resp_for_all_tickers = req_lib.get("https://msewebback-fuc6brbba4bmehcg.germanywestcentral-01.azurewebsites.net/all")
...
def analysed(request):
    if request.method == "POST":
        ...
        latest_available_date_resp = req_lib.get('https://msewebback-fuc6brbba4bmehcg.germanywestcentral-01.azurewebsites.net/tickers/latest/str')
        ...
        url_endpoint = ("https://msewebback-fuc6brbba4bmehcg.germanywestcentral-01.azurewebsites.net/tickers/analyze/oscillators/" + interval_start_with_periods + '/' +
